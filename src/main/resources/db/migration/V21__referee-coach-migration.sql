...
INSERT INTO login (email, name, password, last_login, password_reset_token, admin, role)
SELECT email, name, password, last_login, password_reset_token, 0, 'REFEREE'
FROM referee;

ALTER TABLE game_discussion
    DROP FOREIGN KEY FK_GAME_DISCUSSION_ON_REFEREE1;
ALTER TABLE game_discussion
    DROP FOREIGN KEY FK_GAME_DISCUSSION_ON_REFEREE2;
ALTER TABLE game_discussion
    DROP FOREIGN KEY FK_GAME_DISCUSSION_ON_REFEREE3;
...
ALTER TABLE video_report
    DROP FOREIGN KEY FK_VIDEO_REPORT_ON_REFEREE1ID;
ALTER TABLE video_report
    DROP FOREIGN KEY FK_VIDEO_REPORT_ON_REFEREE2ID;
ALTER TABLE video_report
    DROP FOREIGN KEY FK_VIDEO_REPORT_ON_REFEREE3ID;
ALTER TABLE video_report
    DROP FOREIGN KEY FK_VIDEO_REPORT_ON_REPORTERID;

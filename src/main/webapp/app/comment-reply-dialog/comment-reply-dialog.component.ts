...
@Component({
    ...
    imports: [MatDialogTitle, MatDialogContent, NgIf, MatFormField, MatLabel, CdkTextareaAutosize, MatInput, FormsModule, MatIcon, MatDialogActions, MatButton, MatDialogClose]
})
